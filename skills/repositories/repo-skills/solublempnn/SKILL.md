...
# solublempnn Repo Skill

Use this repo skill when a task involves protein modeling workflows through **solublempnn**.
...
> **First time?** See [Getting started](../protein-design-setup/SKILL.md) to set up Modal and biomodals.
